    ...
    <>
      <div className='p-10'>
        ...
        <div className='text-center my-10 flex flex-col items-center'>
          ...
          <button onClick={() => router.push('/spends')} type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-64">View Totals Category Wise</button>
        </div>
      </div>
      ...
      {isCatFormOpen && <div className='z-50 fixed top-0 left-0 w-full h-full bg-black-rgba'>
